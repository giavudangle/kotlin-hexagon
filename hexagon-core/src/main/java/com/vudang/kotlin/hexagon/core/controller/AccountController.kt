package com.vudang.kotlin.hexagon.core.controller

import com.vudang.kotlin.hexagon.api.dto.AccountDTO
import com.vudang.kotlin.hexagon.api.service.AccountService
import com.vudang.kotlin.hexagon.core.config.RouteConfiguration
...
class AccountController(
    ...
    @ResponseBody
    fun find(@PathVariable id: Long): AccountDTO {
